...
namespace msa {
	namespace controlfreak {
		...
		public:
			...
			// add compound parameters (creates a subgroup)
			...
			// return name or full path of last used XML for saving and/or loading
			string xmlName() const { return ofFilePath::getFileName(_xmlPath); }
			string xmlPath() const { return _xmlPath; }
		...
		protected:
			...
			string _xmlPath; // last loaded or saved xml path;
		};
